...
class $TransactionsTable extends Transactions
  ...
  static const VerificationMeta _ammountMeta = const VerificationMeta(
    'ammount',
  );
  @override
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  Transaction copyWithCompanion(TransactionsCompanion data) {
    return Transaction(
      ...
      ammount: data.ammount.present ? data.ammount.value : this.ammount,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
      deletedAt: data.deletedAt.present ? data.deletedAt.value : this.deletedAt,
    );
...
class $$TransactionsTableFilterComposer
  ...
  ColumnFilters<int> get ammount => $composableBuilder(
    column: $table.ammount,
    builder: (column) => ColumnFilters(column),
  );
...
class $$TransactionsTableOrderingComposer
  ...
  ColumnOrderings<int> get ammount => $composableBuilder(
    column: $table.ammount,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$TransactionsTableAnnotationComposer
  ...
  GeneratedColumn<int> get ammount =>
      $composableBuilder(column: $table.ammount, builder: (column) => column);
